...
<i>Этот параграф написан человеком (владельцем репозитория, мяу). Желающим помочь: форкните репозиторий и внесите свои находки в README.md.</i>
