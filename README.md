# no Telega
блокирует всех новых участников в чате, если они пользуются Telega.

# Принцип работы
### Важное замечание: сводка ниже была написана в соавторстве с ChatGPT. Я не являюсь автором этого замечательного разбора, и не знаю, кто этот замечательный человек.
